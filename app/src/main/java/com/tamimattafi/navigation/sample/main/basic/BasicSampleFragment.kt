...
class BasicSampleFragment : BasicNavigationFragment(),
    SampleFragment<BasicNavigationFragment, BasicSampleFragment, BasicNavigator> {

    override val fragmentName: String = this.javaClass.simpleName

    override val layoutId: Int = R.layout.fragment_basic
    override val launcher: SampleLauncher<BasicSampleFragment> = BasicSampleLauncher()
    ...
    override fun getFragmentNavigator(): BasicNavigator = navigator
